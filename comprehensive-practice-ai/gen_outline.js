...
const MINUTES = { '开场':8, '第一段':10, '第二段':8, '第三段':16, '第四段':12, '第五段':18,
                  '第六段':10, '第七段':8, '附录':0 };
const SECTITLE = {
  '开场':'领航行动指南与本课程的关系',
  '第一段':'做中学对综合实践活动的覆盖范围',
...
const SCREEN = {
  ...
  blankgrid:'六环节配置表，投影显示填写示例，讲义保留空白版',
  shape:'收放刻度图（SVG）',
  ...
  redlines:'四条红线＋边界说明',
  signature:'评价主体与责任二分',
  agentspec:'任务助手示意图（SVG）＋可照抄的指令块',
  toolpos:'工具位置表（全场第二张表）',
  threedo:'三项动作，按周排布',
  endnote:'配套材料、讲义五页结构、出处说明与署名',
  apxcover:'六项案例的目录，含页码与学段',
  apxtask:'任务要求与实施建议的附件原文',
  apxflow:'六个环节的收放配置表，含收放徽章',
  apxrule:'三条约束＋留痕＋教师侧指令示例',
  apxteach:'核心教学判断＋课前准备、学生产出、教师观察与条件受限时的处理'
};
...
const FIGNAME = { coverage:'覆盖关系嵌套图', impact:'四种活动方式的 AI 冲击强度条形图',
                  ...
                  agent:'任务助手示意图：一段指令 × 每次提问', stepbar:'环节位置的迷你刻度' };
function figures() {
